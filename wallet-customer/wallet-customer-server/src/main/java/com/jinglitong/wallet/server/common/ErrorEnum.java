...
public enum ErrorEnum {
    ...
    ERROR_39001(39001,"同步邀请人到游戏方失败"),
    // 用户认证新加错误码
    ERROR_41008(41008,"身份证号已被认证，请重新填写身份信息"),
    ERROR_41009(41009,"身份证号已被认证，请选择审核不通过"),
    // 绑定银行卡
    ERROR_41110(41110,"解绑失败"),
    ERROR_41111(41111,"银行卡添加失败"),
    ERROR_41112(41112,"银行卡不能重复绑定"),
    ERROR_41113(41113,"非法账号，请重新输入"),
    ERROR_41114(41114,"用户只能绑定一张银行卡"),
 // 后端用户审核  同步到mq
