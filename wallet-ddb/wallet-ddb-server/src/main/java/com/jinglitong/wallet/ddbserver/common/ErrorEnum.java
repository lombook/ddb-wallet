...
public enum ErrorEnum {
    ...
    ERROR_41115(41115,"好友关系同步失败"),
    ERROR_41116(41116,"同步邀请人到mq失败"),


    //提现
    ERROR_411201(411201,"参数有误"),
    
    //现贝提现
    ERROR_42000(42000,"获取规则失败"),
    ERROR_42001(42001,"获取银行卡失败，请先绑定银行卡"),
    ERROR_42002(42002,"提现数额不可小于最小提现数额"),
    EROR_42003(42003,"请核对现贝、宝分余额是否足够"),
    
    //宝分兑换mei
    EROR_42100(42100,"兑换规则不存在"),
    EROR_42101(42101,"兑换数额必须是100的倍数"),
    EROR_42102(42102,"兑换数额不可小于最小兑换数额"),
    EROR_42103(42103,"请核对您的宝分余额是否足够"),

    //用户树
    EROR_42200(42200,"请检查EXCEL表格"),
    EROR_42201(42201,"数据处理失败"),
    EROR_42202(42202,"appId异常"),
    
    //积分兑换
    EROR_42300(42300,"获取兑换规则失败"),
    EROR_42301(42301,"兑换数额最小为1"),
    EROR_42302(42302,"兑换数额不可为小数"),
    EROR_42303(42303,"金贝、宝分余额不足"),
    ;
