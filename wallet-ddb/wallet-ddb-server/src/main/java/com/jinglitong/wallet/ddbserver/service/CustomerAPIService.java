...
import com.jinglitong.wallet.ddbserver.common.spring.ApplicationContextHelper;
...
public class CustomerAPIService {
    ...
    public Map<String,Object> chaindetailBao(WalletVO vo) {
        ...
        Iterator<Object> iterator = res.getDataList().iterator();
        HashMap<String, String> stringStringHashMap = new HashMap<>();
        while(iterator.hasNext()){
            LinkedHashMap<String, String> map = (LinkedHashMap<String, String>) iterator.next();
            if(map != null){
                hashMap.put(map.get("currency"),map.get("value"));
            }
        }
        return hashMap;
    ...
    public Map<String,Object> exportwallet(WalletVO vo) throws Exception {
        ...
        if (resvo.getResCode().equals(0)) {
            ...
            if(!StringUtils.isEmpty(account)&&!account.contains("@")) {
            	redisKey = smsExportPrefix +vo.getAppId()+"+"+vo.getCountryCode()+vo.getAccount();
