...
package com.jinglitong.wallet.ddbserver.conf;

import com.jinglitong.wallet.ddbserver.common.redis.RedisCacheManager;
import com.jinglitong.wallet.ddbserver.common.redis.RedisSessionDAO;
import com.jinglitong.wallet.ddbserver.common.shiro.AdminShiroRealm;
import com.jinglitong.wallet.ddbserver.common.shiro.CustomModularRealmAuthenticator;
import com.jinglitong.wallet.ddbserver.common.shiro.CustomSessionListener;
import com.jinglitong.wallet.ddbserver.common.shiro.CustomShiroRealm;
import com.jinglitong.wallet.ddbserver.filter.AdminFormAuthenticationFilter;
import com.jinglitong.wallet.ddbserver.filter.CustomFormAuthenticationFilter;
import com.jinglitong.wallet.ddbserver.filter.KickoutSessionControlFilter;
...
public class ShiroConfiguration  {
    ...
    public ShiroFilterFactoryBean shirFilter(DefaultWebSecurityManager securityManager){
       ...
       // filterChainDefinitionMap.put("/console/**","anon");
        ...
        //配置记住我或认证通过可以访问的地址
        //filterChainDefinitionMap.put("/console/**", "admin");
        filterChainDefinitionMap.put("/customer/common/**", "anon");
        filterChainDefinitionMap.put("/customer/ddb/reg.json", "anon");
        filterChainDefinitionMap.put("/customer/**", "custom");
        filterChainDefinitionMap.put("/withDraw/**", "custom");
        filterChainDefinitionMap.put("/coinExchange/**", "custom");
        filterChainDefinitionMap.put("/MEI/**", "anon");
        filterChainDefinitionMap.put("/ddb/exchange/**", "custom");
        //排除的都 需要登录
