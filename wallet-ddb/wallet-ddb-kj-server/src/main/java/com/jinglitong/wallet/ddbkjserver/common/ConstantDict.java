...
public class ConstantDict {
	 ...
	 * 股份分红制度
	 */
	public static Map<String, Map<String,String>> INIT_BONUS_SYSTEM_GF = new HashMap<>();
	 ...
	 *    数据结构同分红制度
	 */
	public static Map<String, List<SecExpandDicInfo>> INIT_SECOND_SYSTEM = new HashMap<>();
	/**
	 * 股分间接分红
	 */
	public static Map<String, List<SecExpandDicInfo>> INIT_SECOND_SYSTEM_GF = new HashMap<>();
}
