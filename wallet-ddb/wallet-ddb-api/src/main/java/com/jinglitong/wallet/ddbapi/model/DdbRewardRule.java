...
@Table(name = "ddb_reward_rule")
public class DdbRewardRule {
    private Integer id;
	...
	@Transient
    private List<DdbRewardRuleDetail> details;
    ...
    public List<DdbRewardRuleDetail> getDetails() {
		return details;
	}

	public void setDetails(List<DdbRewardRuleDetail> details) {
