...
public class DdbIntegralAccountSeq {
    ...
    public DdbIntegralAccountSeq(String zid, String flowId, String inteId, String realCname, String realName, String inteCname, String inteName, Long beforeAmount, Long amount, Long afterAmount, Integer type, String createTime, String updateTime) {
        this.zid = zid;
        this.flowId = flowId;
        this.inteId = inteId;
