...
import com.jinglitong.wallet.job.mapper.DdbGrowIntegralRecordMapper;
import com.jinglitong.wallet.job.mapper.DdbIntegralAccountMapper;
...
public class GrowInteService {
    ...
    public void growIntege(DdbShouldFrozen ddb) {
        ...
        try {
            excuteTime = sDateFormat.parse(ddb.getExcuteTime());
            //转账
        }catch (Exception e){
            log.info("日期装换失败"+e);
        }
