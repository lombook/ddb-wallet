...
public class MD5 {
    ...
    private String DEFAULT_CHARSET_NAME = "iso8859-1";
    ...
    public String getkeyBeanofStr(String inbuf) {
        keyBeanInit();
        try {
            keyBeanUpdate(inbuf.getBytes(DEFAULT_CHARSET_NAME), inbuf.length());
    ...
    public String getkeyBeanofStr(String inbuf, String encodingChar) {
        DEFAULT_CHARSET_NAME = encodingChar;

        keyBeanInit();
        try {
            keyBeanUpdate(inbuf.getBytes(encodingChar), inbuf.length());
        } catch (UnsupportedEncodingException e) {
            // TODO Auto-generated catch block
            e.printStackTrace();
        }
