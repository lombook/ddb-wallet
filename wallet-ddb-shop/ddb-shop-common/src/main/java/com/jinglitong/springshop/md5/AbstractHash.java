...
public abstract class AbstractHash extends CodecSupport implements Hash, Serializable {
    ...
    public AbstractHash(Object source) throws Exception {
        this(source, (Object)null, 1);
    }

    public AbstractHash(Object source, Object salt) throws Exception {
        this(source, salt, 1);
    }

    public AbstractHash(Object source, Object salt, int hashIterations) throws Exception {
        this.bytes = null;
        this.hexEncoded = null;
        this.base64Encoded = null;
                ...
                if (arg.equals("-base64")) {
                    ...
                    if (arg.equals("-salt")) {
                        ...
                        try {
                            ...
                            String msg1 = "Times argument must be followed by an integer value.";
