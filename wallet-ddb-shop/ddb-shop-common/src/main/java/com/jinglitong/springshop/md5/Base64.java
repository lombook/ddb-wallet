...
public class Base64 {
    ...
    public static String decodeToString(String base64Encoded) throws Exception {
        byte[] encodedBytes = CodecSupport.toBytes(base64Encoded);
        return decodeToString(encodedBytes);
    }

    public static String decodeToString(byte[] base64Encoded) throws Exception {
        byte[] decoded = decode(base64Encoded);
        return CodecSupport.toString(decoded);
    }

    public static byte[] decode(String base64Encoded) throws Exception {
