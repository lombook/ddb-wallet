...
public class DdbIntegralWalletSeq {
    ...
    public DdbIntegralWalletSeq(String zid, String custId, String realCname, String realName, String inteCname, String inteName, Long beforeAmount, Long amount, Long afterAmount, Integer type, Date createTime, Date updateTime, String flowId) {
        this.zid = zid;
        this.custId = custId;
